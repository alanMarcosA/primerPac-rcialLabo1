...
int main(void) {
	...
	crearPedido(pedidos, TAMPED, 2, 2, 10);
	crearPedido(pedidos, TAMPED, 3, 1, 20);
	crearPedido(pedidos, TAMPED, 4, 1, 20);
	crearPedido(pedidos, TAMPED, 5, 2, 10);
	procesarResiduos(pedidos, TAMPED, 4, 5.0, 5.0, 10.0);
	    ...
	    if(res!=-1){
	    	...
	    	switch (opcion) {
	    				...
	    				case 2:
	    					...
	    					codeError3 = utn_getInt(&localidad,"ingrese el numero de localidadr", "vuelva a ingresar el id", -1, 11, 3);
	    				...
	    				case 9:
	    					...
	    					break;
	    				case 10:
	    					clienteConMasPendientes(clientes, TAMCLI, pedidos, TAMPED);
	    					clienteConMasCompletados(clientes, TAMCLI, pedidos, TAMPED);
	    					clienteConMasCompletados(clientes, TAMCLI, pedidos, TAMPED);
	    					break;
	    				case 11:
